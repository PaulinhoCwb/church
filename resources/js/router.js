    ...
    [
        ...
        { path: '/master', component: require('./components/Layout/Master.vue'),
            children: [
                ...
                { path: '/marriage', component: require('./components/Peoples/Marriage.vue'), name: 'marriage'},
                { path: '/catequese/index', component: require('./components/Catequese/Catequese.vue'), name: 'catequese.index'},
                { path: '/catequese/create', component: require('./components/Catequese/FormCatequese.vue'), name: 'catequese.create'},
                ...
                { path: '/avisos', component: require('./components/Avisos/AvisosTable.vue'), name: 'avisos'},
                { path: '/avisos/create', component: require('./components/Avisos/Avisos.vue'), name: 'avisos.create'},
            ] 
        },
      ],
    mode: 'history',
